...
Math.random()};e.prototype.cookieProvider_=null;e.prototype.subscriptions_=null;e.prototype.socketNamespace_=null;e.prototype.connect_=function(){var a=this;microAjax(a.masterUrl+"/getWorker",function(c){var d=(new Function("return "+c))(),c="http://"+d.host+":"+d.port;if(!d.host||!d.port)throw Error("Neutrino has no worker nodes");a.socketNamespace_=io.connect(c,{reconnect:!1});a.socketNamespace_.on("newValue",function(b,c,d,e){a.newValueHandler_(b,c,d,e)});a.socketNamespace_.on("invokeMethodResponse",
