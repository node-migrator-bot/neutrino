...
b.socket_.on("unsubscribeResponse",function(a){b.responseHandler_(a)});b.socket_.on("editResponse",function(a){b.responseHandler_(a)});b.socket_.on("getModelResponse",function(a){b.responseHandler_(a)});b.socket_.on("reconnect",function(){b.reconnectHandler_();b.emit("reconnect")});b.socket_.on("connect",function(){b.emit("connect")});b.socket_.on("disconnect",function(){b.emit("connect")});b.emit("socketReady")})};e.prototype.invoke=function(a,b,d){var c=this,g=c.generateRequestId_(),e=Array.prototype.slice.call(arguments,
