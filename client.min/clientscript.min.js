...
decodeURIComponent(RegExp.$1):null};f.prototype.removeCookie=function(a,b,c){this.setCookie(a,null,new Date(0),b,c);return!0};b.prototype.createRequest_=function(){var a;if("undefined"!==typeof ActiveXObject)try{a=new ActiveXObject("Msxml2.XMLHTTP")}catch(b){a=new ActiveXObject("Microsoft.XMLHTTP")}else a=new XMLHttpRequest;return a};b.prototype.request=function(a,b){var c=this.createRequest_();c.open("GET",a,!0);c.send(null);if(b){var d=function(){4!=c.readyState&&setTimeout(d,10);200==c.status?
b(null,c.responseText):b(Error(c.status),null)};setTimeout(d,10)}};b.prototype.requestJson=function(a,b){this.request(a,function(a,d){try{var f=(new Function("return "+d))();b(null,f)}catch(h){b(h,null)}})}})();